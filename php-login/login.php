    ...
    if(empty($username_err) && empty($password_err)){
        ...
        if($sql->execute()){
            ...
            if($sql->num_rows == 1){                    
                ...
                $sql->bind_result( $id, $username, $hashed_password);
                $sql->fetch();
                if(password_verify($password, $hashed_password)){
                    ...
                    $login_err = "Forkert brugernavn eller kodeord.";
                }
...
<body>
    <div class="wrapper">
        <h2>Login</h2>
        <p>Udfyld venligst dine oplysninger for at logge ind.</p>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Har du ikke en konto? <a href="register.php">Opret dig her</a>.</p>
        </form>
    </div>
</body>
</html>
